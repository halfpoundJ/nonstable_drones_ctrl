...
class DockingPID(BaseControl):
    ...
    def __init__(self,
        ...
        if self.DRONE_MODEL != DroneModel.CF2X:
            print("[ERROR] in DockingPID.__init__(), DockingPID requires DroneModel.CF2X")
            exit()
        ...
        self.COEFF_POS = 16 * (self.GRAVITY/g)
        self.COEFF_VEL = 5.6 * (self.GRAVITY/g)
        ...
        """
        KF: The coefficient converting RPMs into thrust.
        KM: The coefficient converting RPMs into torque.
        """
    ...
    def computeControl(self,
        ...
        if target_rpy[2]!=0:
            print("\n[WARNING] ctrl it", self.control_counter, "in DockingPID.computeControl(), desired yaw={:.0f}deg but locked to 0. for DroneModel.HB".format(target_rpy[2]*(180/np.pi)))
